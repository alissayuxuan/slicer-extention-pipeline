...
def run_pipeline_all_patient():
    ...
    try:
        for patient_ID in os.listdir(patient_data_directory):
            ...
            model_creation_setup_path = os.path.join(patient_directory_path,'setup/model_creation_base_setup.xml')  #this can't be work directory!
...
global_variables = [
    ...
    ('Patient Data Directory'                   ,'patient_data_directory'   , 'Directory'   ,''),
]
...
root = tk.Tk()
root.title('Step 3a(development) - Model Creation Setup & Run ')
...
radio1 = tk.Radiobutton(frame, text='CT & Marker (Default)', variable=selected_var, value=0)
radio2 = tk.Radiobutton(frame, text='CT no Marker ', variable=selected_var, value=1)
